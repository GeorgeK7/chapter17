...
*/
	LinkedList tops = new LinkedList();
...
//		Left -> Right -> Root
	...
	private void SumTreeNodes(BinaryTreeNode<T> root) {
		...
		SumTreeNodes(root.getLeftChild());
		sumTreeNodes += (Integer) root.getValue();
		SumTreeNodes(root.getRightChild());
	}
	public void traverseBFS() {
		this.SumTreeNodes(this.root);
	}
